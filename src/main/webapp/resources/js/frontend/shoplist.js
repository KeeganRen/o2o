...
$(function() {
	...
	// 页码
	var pageNum = 1;
	// 根据地址栏URL获取parent/shop/category的Id
	...
	function addItems(pageSize, pageIndex) {
		// 生成新条目的HTML
		// 拼接出查询的URL，赋空值默认去掉条件限制，有值就按如下条件去查询
	...
	// 选择新的店铺类别后，重置页码清空原店铺列表，按照新的类别去查询
	$('#shoplist-search-div').on('click', '.button', function(e) {
				if (parentId) {// 如果传递过来的是一个父类下的子类
					shopCategoryId = e.target.dataset.categoryId;
					// 若之前选定的其他类别的category，则移除其选定效果，改选新的
	...
	// 区域信息发生变化后，重置页码，清空原店铺列表，按照新的区域进行查询
